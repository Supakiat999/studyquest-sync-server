(function(root) {
  ...
  function install(bridge) {
    ...
    const help=root.document.createElement('section');help.id='v21Help';help.innerHTML='<strong>Laptop v21</strong> · Your existing admin connection<div class="v21-actions"><button class="btn btn-ghost" id="v21Check">Check sync / recover</button><button class="btn btn-ghost" id="v21Export">Export laptop copies</button><button class="btn btn-ghost" id="v21Retry">Retry device storage</button></div><p id="v21Message" role="status">Opening this version does not approve a merge. Check sync if tasks appear missing.</p>';
